...
@Component({
  selector: 'app-health-claim-upload',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './health-claim-upload.html',
  styleUrl: './health-claim-upload.scss'
})
export class HealthClaimUploadComponent implements OnInit {
